...
data_train = 'YC.Bio/src/NN2/trna_5840classes_220/data/train.csv'
data_valid = 'YC.Bio/src/NN2/trna_5840classes_220/data/valid.csv'
weights = 'model_084_9728(base).h5'
weights2 = 'model_04_98(base2).h5'
species = 'YC.Bio/src/NN2/trna_5840classes_220/data/species.txt'

with open(species, 'r') as inp:
...
csv_logger = CSVLogger('model_7.8_001.log')
...
model4.save_weights('model_7.8_001.h5')
