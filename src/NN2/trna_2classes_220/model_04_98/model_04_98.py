...
data_train = 'YC.Bio/src/NN2/trna_2classes_220/data/train.csv'
data_valid = 'YC.Bio/src/NN2/trna_2classes_220/data/valid.csv'
...
csv_logger = CSVLogger('model_04_98.log')
...
model2.save_weights('model_04_98.h5')
