...
data_train ='YC.Bio/src/NN1/vectors/16sRNA_detection_512/data/train.csv'
data_valid ='YC.Bio/src/NN1/vectors/16sRNA_detection_512/data/valid.csv'
...
model.save_weights('model_025_90.h5')