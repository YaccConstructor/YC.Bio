...
let summary = "Tools for metagenomic assembly processing."

// Longer description of the project
// (used as a description for NuGet package; line breaks are automatically cleaned up)
let description = "Tools for metagenomic assembly processing."

// List of author names (for NuGet package)
let authors = [ "YaccConstructor software foundation" ]

// Tags for your project (for NuGet package)
let tags = "fsharp bioinformatics metagenomics metagenomic-analysis parsing 16s rrna secondary-structure"

// File system information
let solutionFile  = "YC.Bio.sln"
